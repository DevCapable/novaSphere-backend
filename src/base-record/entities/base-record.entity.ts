...
export enum BaseRecordEnum {
  ...
  RESEARCH_CENTER_OF_EXCELLENCE = 'RESEARCH_CENTER_OF_EXCELLENCE',
  RESEARCH_FOCUS_AREA = 'RESEARCH_FOCUS_AREA',
  DEPARTMENT = 'DEPARTMENT',
  RESEARCH_THEMATIC_AREA = 'RESEARCH_THEMATIC_AREA',
  SERVICE_UTILIZATION_TYPE = 'SERVICE_UTILIZATION_TYPE',
  SERVICE_UTILIZATION_CATEGORY = 'SERVICE_UTILIZATION_CATEGORY',
